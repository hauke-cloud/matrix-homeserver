...
Helm chart to deploy a Matrix homeserver incl. database deployment

This chart offers you:
- State of the art Matrix homeserver
- Postgres database based on Crunchydata PGO
- SSO security
- Hardening
...
```bash
helm template oci://ghcr.io/hauke-cloud/charts/matrix-homeserver
```

#### Deploy the Helm chart

```bash
helm install matrix-homeserver oci://ghcr.io/hauke-cloud/charts/matrix-homeserver --version 1.0.0
```
